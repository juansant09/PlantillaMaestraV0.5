...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base/5 font-medium transform-gpu transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 hover:-translate-y-[1px] hover:shadow-[0_0_15px_rgba(0,255,200,0.25)] [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-secondary shadow-[inset_0_1px_2px_0_rgba(255,255,255,0.3)] text-white hover:bg-[#274FEB]",
        destructive:
